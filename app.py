...
# --- PWA用アイコンとマニフェスト設定 ---
st.markdown("""
    <link rel="apple-touch-icon" sizes="180x180" href="https://raw.githubusercontent.com/MKato2361/carender-import-app/main/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="192x192" href="https://raw.githubusercontent.com/MKato2361/carender-import-app/main/icon-192.png">
    <link rel="icon" type="image/png" sizes="512x512" href="https://raw.githubusercontent.com/MKato2361/carender-import-app/main/icon-512.png">
    <link rel="manifest" href="https://raw.githubusercontent.com/MKato2361/carender-import-app/main/manifest.json">
